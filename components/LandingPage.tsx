...
import { Sprout, MapPin, Mail, Lock, Instagram, ArrowRight, ChefHat, Droplets, Sparkles, TrendingUp, Leaf, CheckCircle2 } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="bg-gradient-to-r from-teal-600 via-emerald-600 to-teal-600 bg-[length:200%_auto] bg-clip-text text-transparent animate-gradient">
                Big Flavor.
              </span>
            </motion.h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, idx) => (
              <motion.div
                ...
                className="group relative bg-white p-8 rounded-3xl border border-slate-200 shadow-sm hover:shadow-xl transition-all duration-300"
              >
